...
See [https://www.systeminvariant.dev/docs/how-to/s3-assessment](https://www.systeminvariant.dev/docs/how-to/s3-assessment) for the recommended workflow showing the credential boundary between user tools and Stave.
