...
- **290 built-in controls** across 34 domains (S3, IAM, VPC, EC2, RDS, ELB, K8s, CloudTrail, CloudWatch, KMS, and [24 more](docs/controls/reference.md))
...
290 controls across 34 domains:
