...
- **839 built-in controls** across 57 domains (S3, IAM, VPC, EC2, RDS, ELB, K8s, CloudTrail, CloudWatch, KMS, and [47 more](docs/controls/reference.md))
...
839 controls across 57 domains:
