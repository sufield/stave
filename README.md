...
- **2673 built-in controls across 74 domains** — S3, IAM, VPC, EC2, RDS, Lambda, ECS, EKS, CloudTrail, KMS, OpenSearch, SageMaker, Bedrock, Cognito, and [60 more](docs/controls/reference.md).
