...
The Go binary. No dependencies beyond Go itself. Does CEL evaluation against 2593+ controls and fact export (JSONL, SMT-LIB).
...
2593 controls across 74 domains:
