...
- **299 built-in controls** across 36 domains (S3, IAM, VPC, EC2, RDS, ELB, K8s, CloudTrail, CloudWatch, KMS, and [26 more](docs/controls/reference.md))
...
299 controls across 36 domains:
