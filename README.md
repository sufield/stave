...
- **803 built-in controls** across 54 domains (S3, IAM, VPC, EC2, RDS, ELB, K8s, CloudTrail, CloudWatch, KMS, and [44 more](docs/controls/reference.md))
...
803 controls across 54 domains:
