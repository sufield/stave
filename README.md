...
- **309 built-in controls** across 39 domains (S3, IAM, VPC, EC2, RDS, ELB, K8s, CloudTrail, CloudWatch, KMS, and [29 more](docs/controls/reference.md))
...
309 controls across 39 domains:
