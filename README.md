...
- **820 built-in controls** across 55 domains (S3, IAM, VPC, EC2, RDS, ELB, K8s, CloudTrail, CloudWatch, KMS, and [45 more](docs/controls/reference.md))
...
820 controls across 55 domains:
