...
The Go binary. No dependencies beyond Go itself. Does CEL evaluation against 2592+ controls and fact export (JSONL, SMT-LIB).
...
2592 controls across 74 domains:
