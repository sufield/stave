...
- **752 built-in controls** across 48 domains (S3, IAM, VPC, EC2, RDS, ELB, K8s, CloudTrail, CloudWatch, KMS, and [38 more](docs/controls/reference.md))
...
752 controls across 48 domains:
