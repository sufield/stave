...
- **313 built-in controls** across 40 domains (S3, IAM, VPC, EC2, RDS, ELB, K8s, CloudTrail, CloudWatch, KMS, and [30 more](docs/controls/reference.md))
...
313 controls across 40 domains:
