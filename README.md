...
- **289 built-in controls** across 32 domains (S3, IAM, VPC, EC2, RDS, ELB, K8s, CloudTrail, CloudWatch, KMS, and [22 more](docs/controls/reference.md))
...
289 controls across 32 domains:
