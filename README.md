...
- **2907 built-in controls across 86 domains** — S3, IAM, VPC, EC2, RDS, Lambda, ECS, EKS, CloudTrail, KMS, OpenSearch, SageMaker, Bedrock, Cognito, and [72 more](docs/controls/reference.md).
...
2907 controls across 86 domains. Largest surfaces today: AWS S3 (133), AWS IAM (222), AWS OpenSearch (132), GCP Cloud Storage (7), DNS (3, vendor-agnostic dangling-reference detection).
