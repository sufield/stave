...
- **857 built-in controls** across 67 domains (S3, IAM, VPC, EC2, RDS, ELB, K8s, CloudTrail, CloudWatch, KMS, and [57 more](docs/controls/reference.md))
...
857 controls across 67 domains:
