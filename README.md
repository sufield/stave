...
- **764 built-in controls** across 49 domains (S3, IAM, VPC, EC2, RDS, ELB, K8s, CloudTrail, CloudWatch, KMS, and [39 more](docs/controls/reference.md))
...
764 controls across 49 domains:
