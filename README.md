...
- **845 built-in controls** across 58 domains (S3, IAM, VPC, EC2, RDS, ELB, K8s, CloudTrail, CloudWatch, KMS, and [48 more](docs/controls/reference.md))
...
845 controls across 58 domains:
