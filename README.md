...
- **775 built-in controls** across 50 domains (S3, IAM, VPC, EC2, RDS, ELB, K8s, CloudTrail, CloudWatch, KMS, and [40 more](docs/controls/reference.md))
...
775 controls across 50 domains:
