...
- **2717 built-in controls across 77 domains** — S3, IAM, VPC, EC2, RDS, Lambda, ECS, EKS, CloudTrail, KMS, OpenSearch, SageMaker, Bedrock, Cognito, and [63 more](docs/controls/reference.md).
...
2717 controls across 77 domains. Largest surfaces today: AWS S3 (125), AWS IAM (186), AWS OpenSearch (132), GCP Cloud Storage (7), DNS (3, vendor-agnostic dangling-reference detection).
