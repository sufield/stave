...
- **740 built-in controls** across 47 domains (S3, IAM, VPC, EC2, RDS, ELB, K8s, CloudTrail, CloudWatch, KMS, and [37 more](docs/controls/reference.md))
...
740 controls across 47 domains:
