...
- **296 built-in controls** across 35 domains (S3, IAM, VPC, EC2, RDS, ELB, K8s, CloudTrail, CloudWatch, KMS, and [25 more](docs/controls/reference.md))
...
296 controls across 35 domains:
