...
- **228 built-in controls** across 28 domains (S3, IAM, VPC, EC2, RDS, ELB, K8s, CloudTrail, CloudWatch, KMS, and [18 more](docs/controls/reference.md))
...
228 controls across 28 domains:
