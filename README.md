...
- **345 built-in controls** across 41 domains (S3, IAM, VPC, EC2, RDS, ELB, K8s, CloudTrail, CloudWatch, KMS, and [31 more](docs/controls/reference.md))
...
345 controls across 41 domains:
