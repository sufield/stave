...
- **282 built-in controls** across 31 domains (S3, IAM, VPC, EC2, RDS, ELB, K8s, CloudTrail, CloudWatch, KMS, and [21 more](docs/controls/reference.md))
...
282 controls across 31 domains:
