...
- **793 built-in controls** across 53 domains (S3, IAM, VPC, EC2, RDS, ELB, K8s, CloudTrail, CloudWatch, KMS, and [43 more](docs/controls/reference.md))
...
793 controls across 53 domains:
