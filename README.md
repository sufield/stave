...
- **711 built-in controls** across 45 domains (S3, IAM, VPC, EC2, RDS, ELB, K8s, CloudTrail, CloudWatch, KMS, and [35 more](docs/controls/reference.md))
...
711 controls across 45 domains:
