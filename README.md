...
- **833 built-in controls** across 56 domains (S3, IAM, VPC, EC2, RDS, ELB, K8s, CloudTrail, CloudWatch, KMS, and [46 more](docs/controls/reference.md))
...
833 controls across 56 domains:
