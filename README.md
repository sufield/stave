...
- **301 built-in controls** across 37 domains (S3, IAM, VPC, EC2, RDS, ELB, K8s, CloudTrail, CloudWatch, KMS, and [27 more](docs/controls/reference.md))
...
301 controls across 37 domains:
