...
- **308 built-in controls** across 37 domains (S3, IAM, VPC, EC2, RDS, ELB, K8s, CloudTrail, CloudWatch, KMS, and [27 more](docs/controls/reference.md))
...
308 controls across 37 domains:
