...
`aclements/go-z3` binding), grounded
...
`z3prove/` is a separate Go module so its libz3 link does not infect Stave's vendored
tree.
...
This is structurally the same model as this example and this example,
