#!/usr/bin/env bash
# S3 demo: ACL Privilege Escalation
# Migrated from docs-content/demo/scenarios/acl-escalation/. Pure stave + python
...
fmt_section "Findings — ACL Privilege Escalation"
