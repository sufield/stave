...
| V5 `wildcard_action_resource` | `has_action(R, "s3:*") ∧ has_resource(R, "*")` | Iter-7a wildcard-on-wildcard pattern |
...
- **rhino-vulnerable**: V1 does **not** fire — none of the
  ...
  the iter-15 controls attribute findings to the
...
- **cognito-writeup / remediated**: V3
  ...
  the iter-16 article describes, recovered without any
  CEL/SMT.
