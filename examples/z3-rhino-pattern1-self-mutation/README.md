...
this example prover added 4 more. The structural shape is the
...
The example already does this via the go-z3 binding
...
- **Not a replacement for the existing Z3 prover.**
