// Command s3-dotgit-readable demonstrates Stave's library API
// against the s3-dotgit-readable invariant — a public S3
// bucket whose object key set includes version-control
// artefacts (.git/, .svn/, .env) that turn a routine static-
// site bucket into a source-code disclosure primitive.
//
...
const (
	invariantID stave.ControlID = "CTL.S3.REPO.ARTIFACT.001"
