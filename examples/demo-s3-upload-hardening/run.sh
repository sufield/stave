#!/usr/bin/env bash
# S3 demo: Upload Policy Hardening
# Migrated from docs-content/demo/scenarios/upload-hardening/. Pure stave + python
...
fmt_section "Findings — Upload Policy Hardening"
