...
// It carries the CoverageResult payload plus a kernel.Sanitizer and delegates
// to the writeDOT / writeJSON helpers.
...
// the format (ParseFormat) treat that error as an unreachable no-op.
