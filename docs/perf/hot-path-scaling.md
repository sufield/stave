...
**Catalog:** 2673 controls, 603 chains
...
2. **CEL compilation/evaluation dominates** — 2673 controls × 2 assets
...
size is CEL evaluation volume (2673 controls), not collector contention.
