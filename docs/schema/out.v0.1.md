...
This page documents the evaluation output contract used by Stave. Every `apply` and `evaluate --profile mvp1-s3` command produces JSON conforming to this structure.
