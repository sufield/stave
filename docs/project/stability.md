...
- CLI reference pages are generated by sibling `../publisher` tooling to reduce drift.
- Docs artifacts can be regenerated via `make docs-gen` (publisher delegation) and validated in publisher workflows.
