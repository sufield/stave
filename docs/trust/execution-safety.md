...
- [`internal/domain/kernel/airgap.go`](../../internal/domain/kernel/airgap.go)
...
The operator set is defined in [`internal/domain/predicate/operators.go`](../../internal/domain/predicate/operators.go) and tested against drift.
