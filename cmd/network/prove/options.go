...
var validProperties = []string{"bastion-ssh", "prod-dev-isolation", "database-isolation", "firewall-mandatory"}
...
func addFlags(cmd *cobra.Command, o *options) {
	...
	f.StringVar(&o.property, "property", "bastion-ssh", "safety property to verify: bastion-ssh, prod-dev-isolation, database-isolation, firewall-mandatory")
