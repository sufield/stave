...
func TestNewRenderer_UnknownFormatErrors(t *testing.T) {
	...
	// Error message is the same as the pre-migration validation
	// switch produced — operators relying on grep / scripted checks
	// of the failure message see no change.
