...
Examples:
  ...
  stave snapshot archive --observations ./observations --archive-dir ./observations/archive --older-than 14d --now 2026-01-20T00:00:00Z --dry-run` + metadata.OfflineHelpSuffix,
	...
	cmd.Flags().StringVar(&opts.OlderThan, "older-than", projconfig.Global().SnapshotRetention(), cmdutil.WithDynamicDefaultHelp("Archive snapshots older than this age (e.g., 14d, 720h)"))
