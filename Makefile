...
## arch-test: Run architecture checks as Go tests (arch-go).
...
## gen-contract: Regenerate collector-contract.yaml from control predicate fields
gen-contract:
	@python3 scripts/gen-contract.py

## validate-contract: Verify committed contract matches what gen-contract would produce
validate-contract:
	@python3 scripts/gen-contract.py --check
