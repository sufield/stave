...
.PHONY: xa-checklist
xa-checklist:
	@python3 tools/xa-inventory.py --controls-dir internal/controls --checklist > data/frameworks/cross-account-v1.yaml
	@echo "Generated data/frameworks/cross-account-v1.yaml"
