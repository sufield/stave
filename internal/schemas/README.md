...
|--------|------|---------|-----------|
| `control.v1` | `control/v1/control.schema.json` | Control definition YAML structure | `stave lint --type control`, control loading |
| `observation.v1` | `observation/v1/observation.schema.json` | Observation snapshot structure (`obs.v0.1`) | `stave lint --type observation`, snapshot ingest |
