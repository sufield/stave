...
func BuildFindingDetail(r *evaluation.ComplianceReport, req evaluation.FindingDetailRequest, gen ports.IdentityGenerator) (*evaluation.FindingDetail, error) {
	violation := r.GetFindingByResource(req.ControlID, req.AssetID)
	if violation == nil {
