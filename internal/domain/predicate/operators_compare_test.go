...
func TestEvaluate(t *testing.T) {
	tests := []struct {
		...
		{"unknown op fail closed", "custom", 1, 1, false},
	}
...
func TestEvaluateOperatorDispatch(t *testing.T) {
	tests := []struct {
		...
		{"eq true", "eq", true, "a", "a", true, true},
		{"eq bool-string true", "eq", true, true, "TRUE", true, true},
		{"ne bool-string false", "ne", true, true, "TRUE", false, true},
		{"eq missing", "eq", false, nil, "a", false, true},
		{"eq nil value present", "eq", true, nil, "AES256", false, true},
		{"ne nil value present", "ne", true, nil, "AES256", true, true},
		{"ne missing", "ne", false, nil, "a", true, true},
		{"gt", "gt", true, 3, 2, true, true},
		{"lt", "lt", true, 1, 2, true, true},
		{"gte", "gte", true, 2, 2, true, true},
		{"lte", "lte", true, 2, 2, true, true},
		{"missing true", "missing", false, nil, true, true, true},
		{"missing false", "missing", true, "x", false, true, true},
		{"present true", "present", true, "x", true, true, true},
		{"present false for empty", "present", true, "", false, true, true},
		{"in true", "in", true, "a", []string{"a", "b"}, true, true},
		{"list_empty true for missing", "list_empty", false, nil, true, true, true},
		{"contains true", "contains", true, "hello world", "world", true, true},
		{"context op delegated", OpAnyMatch, true, []any{}, map[string]any{}, false, false},
		{"unknown op", "custom", true, 1, 1, false, false},
	}
