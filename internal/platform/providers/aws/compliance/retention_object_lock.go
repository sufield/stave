	...
	core.RegisterControl(func() core.Control {
		return &retentionObjectLock{
			Definition: core.NewDefinition(
				core.WithID("RETENTION.002"),
				core.WithDescription("Object Lock must be enabled for PHI retention (6-year HIPAA minimum)"),
				core.WithSeverity(policy.SeverityHigh),
				core.WithComplianceProfiles("hipaa"),
				core.WithComplianceRef("hipaa", "§164.316(b)(2)"),
				core.WithProfileRationale("hipaa", "6-year PHI retention via Object Lock"),
			),
		}
	})
}
...
func (ctl *retentionObjectLock) Evaluate(snap asset.Snapshot) core.Outcome {
