...
func (e S3Encryption) IsKMS() bool {
	return strings.EqualFold(e.Algorithm, string(aws.AlgorithmAWSKMS))
}
...
// all S3 compliance controls. It is a free function rather than a
// method on core.Definition because Go forbids attaching methods to
// types declared in another package.
func evaluateS3Buckets(d core.Definition, snap asset.Snapshot, fn func(asset.Asset, S3Properties) *core.Outcome) core.Outcome {
